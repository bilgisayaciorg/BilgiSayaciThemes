...
}).addClass("ui-tabs-anchor").attr({role:"presentation",tabIndex:-1}),this.panels=t(),this.anchors.each(function(i,s){var n,o,a,r=t(s).uniqueId().attr("id"),h=t(s).closest("li"),l=h.attr("aria-controls");e._isLocal(s)?(n=s.hash,a=n.substring(1),o=e.element.find(e._sanitizeSelector(n))):(a=h.attr("aria-controls")||t({}).uniqueId()[0].id,n="#"+a,o=e.element.find(n),o.length||(o=e._createPanel(a),o.insertAfter(e.panels[i-1]||e.tablist)),o.attr("aria-live","polite")),o.length&&(e.panels=e.panels.add(o)),l&&h.data("ui-tabs-aria-controls",l),h.attr({"aria-controls":a,"aria-labelledby":r}),o.attr("aria-labelledby",r)}),this.panels.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").attr("role","tabpanel"),i&&(this._off(i.not(this.tabs)),this._off(s.not(this.anchors)),this._off(n.not(this.panels)))},_getList:function(){return this.tablist||this.element.find("ol,ul").eq(0)},_createPanel:function(e){return t("<div>").attr("id",e).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").data("ui-tabs-destroy",!0)},_setupDisabled:function(e){t.isArray(e)&&(e.length?e.length===this.anchors.length&&(e=!0):e=!1);for(var i,s=0;i=this.tabs[s];s++)e===!0||-1!==t.inArray(s,e)?t(i).addClass("ui-state-disabled").attr("aria-disabled","true"):t(i).removeClass("ui-state-disabled").removeAttr("aria-disabled");this.options.disabled=e},_setupEvents:function(e){var i={};e&&t.each(e.split(" "),function(t,e){i[e]="_eventHandler"}),this._off(this.anchors.add(this.tabs).add(this.panels)),this._on(!0,this.anchors,{click:function(t){t.preventDefault()}}),this._on(this.anchors,i),this._on(this.tabs,{keydown:"_tabKeydown"}),this._on(this.panels,{keydown:"_panelKeydown"}),this._focusable(this.tabs),this._hoverable(this.tabs)},_setupHeightStyle:function(e){var i,s=this.element.parent();"fill"===e?(i=s.height(),i-=this.element.outerHeight()-this.element.height(),this.element.siblings(":visible").each(function(){var e=t(this),s=e.css("position");"absolute"!==s&&"fixed"!==s&&(i-=e.outerHeight(!0))}),this.element.children().not(this.panels).each(function(){i-=t(this).outerHeight(!0)}),this.panels.each(function(){t(this).height(Math.max(0,i-t(this).innerHeight()+t(this).height()))}).css("overflow","auto")):"auto"===e&&(i=0,this.panels.each(function(){i=Math.max(i,t(this).height("").height())}).height(i))},_eventHandler:function(e){var i=this.options,s=this.active,n=t(e.currentTarget),o=n.closest("li"),a=o[0]===s[0],r=a&&i.collapsible,h=r?t():this._getPanelForTab(o),l=s.length?this._getPanelForTab(s):t(),u={oldTab:s,oldPanel:l,newTab:r?t():o,newPanel:h};e.preventDefault(),o.hasClass("ui-state-disabled")||o.hasClass("ui-tabs-loading")||this.running||a&&!i.collapsible||this._trigger("beforeActivate",e,u)===!1||(i.active=r?!1:this.tabs.index(o),this.active=a?t():o,this.xhr&&this.xhr.abort(),l.length||h.length||t.error("jQuery UI Tabs: Mismatching fragment identifier."),h.length&&this.load(this.tabs.index(o),e),this._toggle(e,u))},_toggle:function(e,i){function s(){o.running=!1,o._trigger("activate",e,i)}function n(){i.newTab.closest("li").addClass("ui-tabs-active ui-state-active"),a.length&&o.options.show?o._show(a,o.options.show,s):(a.show(),s())}var o=this,a=i.newPanel,r=i.oldPanel;this.running=!0,r.length&&this.options.hide?this._hide(r,this.options.hide,function(){i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"),n()}):(i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"),r.hide(),n()),r.attr("aria-hidden","true"),i.oldTab.attr({"aria-selected":"false","aria-expanded":"false"}),a.length&&r.length?i.oldTab.attr("tabIndex",-1):a.length&&this.tabs.filter(function(){return 0===t(this).attr("tabIndex")}).attr("tabIndex",-1),a.attr("aria-hidden","false"),i.newTab.attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0})},_activate:function(e){var i,s=this._findActive(e);s[0]!==this.active[0]&&(s.length||(s=this.active),i=s.find(".ui-tabs-anchor")[0],this._eventHandler({target:i,currentTarget:i,preventDefault:t.noop}))},_findActive:function(e){return e===!1?t():this.tabs.eq(e)},_getIndex:function(t){return"string"==typeof t&&(t=this.anchors.index(this.anchors.filter("[href$='"+t+"']"))),t},_destroy:function(){this.xhr&&this.xhr.abort(),this.element.removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible"),this.tablist.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").removeAttr("role"),this.anchors.removeClass("ui-tabs-anchor").removeAttr("role").removeAttr("tabIndex").removeUniqueId(),this.tablist.unbind(this.eventNamespace),this.tabs.add(this.panels).each(function(){t.data(this,"ui-tabs-destroy")?t(this).remove():t(this).removeClass("ui-state-default ui-state-active ui-state-disabled ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-panel").removeAttr("tabIndex").removeAttr("aria-live").removeAttr("aria-busy").removeAttr("aria-selected").removeAttr("aria-labelledby").removeAttr("aria-hidden").removeAttr("aria-expanded").removeAttr("role")}),this.tabs.each(function(){var e=t(this),i=e.data("ui-tabs-aria-controls");i?e.attr("aria-controls",i).removeData("ui-tabs-aria-controls"):e.removeAttr("aria-controls")}),this.panels.show(),"content"!==this.options.heightStyle&&this.panels.css("height","")},enable:function(e){var i=this.options.disabled;i!==!1&&(void 0===e?i=!1:(e=this._getIndex(e),i=t.isArray(i)?t.map(i,function(t){return t!==e?t:null}):t.map(this.tabs,function(t,i){return i!==e?i:null})),this._setupDisabled(i))},disable:function(e){var i=this.options.disabled;if(i!==!0){if(void 0===e)i=!0;else{if(e=this._getIndex(e),-1!==t.inArray(e,i))return;i=t.isArray(i)?t.merge([e],i).sort():[e]}this._setupDisabled(i)}},load:function(e,i){e=this._getIndex(e);var s=this,n=this.tabs.eq(e),o=n.find(".ui-tabs-anchor"),a=this._getPanelForTab(n),r={tab:n,panel:a};this._isLocal(o[0])||(this.xhr=t.ajax(this._ajaxSettings(o,i,r)),this.xhr&&"canceled"!==this.xhr.statusText&&(n.addClass("ui-tabs-loading"),a.attr("aria-busy","true"),this.xhr.success(function(t){setTimeout(function(){a.html(t),s._trigger("load",i,r)},1)}).complete(function(t,e){setTimeout(function(){"abort"===e&&s.panels.stop(!1,!0),n.removeClass("ui-tabs-loading"),a.removeAttr("aria-busy"),t===s.xhr&&delete s.xhr},1)})))},_ajaxSettings:function(e,i,s){var n=this;return{url:e.attr("href"),beforeSend:function(e,o){return n._trigger("beforeLoad",i,t.extend({jqXHR:e,ajaxSettings:o},s))}}},_getPanelForTab:function(e){var i=t(e).attr("aria-controls");return this.element.find(this._sanitizeSelector("#"+i))}}),t.widget("ui.tooltip",{version:"1.11.2",options:{content:function(){var e=t(this).attr("title")||"";return t("<a>").text(e).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,tooltipClass:null,track:!1,close:null,open:null},_addDescribedBy:function(e,i){var s=(e.attr("aria-describedby")||"").split(/\s+/);s.push(i),e.data("ui-tooltip-id",i).attr("aria-describedby",t.trim(s.join(" ")))},_removeDescribedBy:function(e){var i=e.data("ui-tooltip-id"),s=(e.attr("aria-describedby")||"").split(/\s+/),n=t.inArray(i,s);-1!==n&&s.splice(n,1),e.removeData("ui-tooltip-id"),s=t.trim(s.join(" ")),s?e.attr("aria-describedby",s):e.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"}),this.tooltips={},this.parents={},this.options.disabled&&this._disable(),this.liveRegion=t("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).addClass("ui-helper-hidden-accessible").appendTo(this.document[0].body)},_setOption:function(e,i){var s=this;return"disabled"===e?(this[i?"_disable":"_enable"](),void(this.options[e]=i)):(this._super(e,i),void("content"===e&&t.each(this.tooltips,function(t,e){s._updateContent(e.element)})))},_disable:function(){var e=this;t.each(this.tooltips,function(i,s){var n=t.Event("blur");n.target=n.currentTarget=s.element[0],e.close(n,!0)}),this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.is("[title]")&&e.data("ui-tooltip-title",e.attr("title")).removeAttr("title")})},_enable:function(){this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.data("ui-tooltip-title")&&e.attr("title",e.data("ui-tooltip-title"))})},open:function(e){var i=this,s=t(e?e.target:this.element).closest(this.options.items);s.length&&!s.data("ui-tooltip-id")&&(s.attr("title")&&s.data("ui-tooltip-title",s.attr("title")),s.data("ui-tooltip-open",!0),e&&"mouseover"===e.type&&s.parents().each(function(){var e,s=t(this);s.data("ui-tooltip-open")&&(e=t.Event("blur"),e.target=e.currentTarget=this,i.close(e,!0)),s.attr("title")&&(s.uniqueId(),i.parents[this.id]={element:this,title:s.attr("title")},s.attr("title",""))}),this._updateContent(s,e))},_updateContent:function(t,e){var i,s=this.options.content,n=this,o=e?e.type:null;return"string"==typeof s?this._open(e,t,s):(i=s.call(t[0],function(i){t.data("ui-tooltip-open")&&n._delay(function(){e&&(e.type=o),this._open(e,t,i)})}),void(i&&this._open(e,t,i)))},_open:function(e,i,s){function n(t){u.of=t,a.is(":hidden")||a.position(u)}var o,a,r,h,l,u=t.extend({},this.options.position);if(s){if(o=this._find(i))return void o.tooltip.find(".ui-tooltip-content").html(s);i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),o=this._tooltip(i),a=o.tooltip,this._addDescribedBy(i,a.attr("id")),a.find(".ui-tooltip-content").html(s),this.liveRegion.children().hide(),s.clone?(l=s.clone(),l.removeAttr("id").find("[id]").removeAttr("id")):l=s,t("<div>").html(l).appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:n}),n(e)):a.position(t.extend({of:i},this.options.position)),a.hide(),this._show(a,this.options.show),this.options.show&&this.options.show.delay&&(h=this.delayedShow=setInterval(function(){a.is(":visible")&&(n(u.of),clearInterval(h))},t.fx.interval)),this._trigger("open",e,{tooltip:a}),r={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var s=t.Event(e);s.currentTarget=i[0],this.close(s,!0)}}},i[0]!==this.element[0]&&(r.remove=function(){this._removeTooltip(a)}),e&&"mouseover"!==e.type||(r.mouseleave="close"),e&&"focusin"!==e.type||(r.focusout="close"),this._on(!0,i,r)}},close:function(e){var i,s=this,n=t(e?e.currentTarget:this.element),o=this._find(n);o&&(i=o.tooltip,o.closing||(clearInterval(this.delayedShow),n.data("ui-tooltip-title")&&!n.attr("title")&&n.attr("title",n.data("ui-tooltip-title")),this._removeDescribedBy(n),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,function(){s._removeTooltip(t(this))}),n.removeData("ui-tooltip-open"),this._off(n,"mouseleave focusout keyup"),n[0]!==this.element[0]&&this._off(n,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,function(e,i){t(i.element).attr("title",i.title),delete s.parents[e]}),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1)))},_tooltip:function(e){var i=t("<div>").attr("role","tooltip").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content "+(this.options.tooltipClass||"")),s=i.uniqueId().attr("id");return t("<div>").addClass("ui-tooltip-content").appendTo(i),i.appendTo(this.document[0].body),this.tooltips[s]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_destroy:function(){var e=this;t.each(this.tooltips,function(i,s){var n=t.Event("blur"),o=s.element;n.target=n.currentTarget=o[0],e.close(n,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))}),this.liveRegion.remove()}})}),jQuery(function(t){t.datepicker.regional.tr={closeText:"kapat",prevText:"&#x3c;geri",nextText:"ileri&#x3e",currentText:"bugün",monthNames:["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],monthNamesShort:["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],dayNames:["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],dayNamesShort:["Paz","Pzt","Sal","Çar","Per","Cum","Cmt"],dayNamesMin:["Paz","Pzt","Sal","Çar","Per","Cum","Cmt"],weekHeader:"Hf",dateFormat:"dd.mm.yy",firstDay:1,isRTL:!1,showMonthAfterYear:!1,yearSuffix:""},t.datepicker.setDefaults(t.datepicker.regional.tr)}),function(t){function e(e,d){var p=t.extend({},t.fn.countdowntimer.defaults,d),e=e;e.addClass("style");var f="",m="",g="",v="";if(f=p.size,m=p.borderColor,g=p.fontColor,v=p.backgroundColor,void 0!=d.regexpMatchFormat&&void 0!=d.regexpReplaceWith&&void 0==d.timeSeparator&&(window["regexpMatchFormat_"+e.attr("id")]=d.regexpMatchFormat,window["regexpReplaceWith_"+e.attr("id")]=d.regexpReplaceWith),void 0!=d.borderColor||void 0!=d.fontColor||void 0!=d.backgroundColor){var _={background:v,color:g,"border-color":m};e.css(_)}else e.addClass("colorDefinition");if(void 0!=d.size)switch(f){case"xl":e.addClass("size_xl");break;case"lg":e.addClass("size_lg");break;case"md":e.addClass("size_md");break;case"sm":e.addClass("size_sm");break;case"xs":e.addClass("size_xs")}else"sm"==f&&e.addClass("size_sm");if(void 0!=d.startDate||void 0!=d.dateAndTime||void 0!=d.currentTime||void 0==d.hours&&void 0==d.minutes&&void 0==d.seconds)if(void 0!=d.startDate&&void 0!=d.dateAndTime&&void 0==d.currentTime){startDate="",endDate="",timer_startDate="",window["startDate"+e.attr("id")]=new Date(p.startDate),window["endDate"+e.attr("id")]=new Date(p.dateAndTime);var w="withStart";l(e,p,w),window["timer_startDate"+e.attr("id")]=setInterval(function(){l(e,p,w)},1e3*p.tickInterval)}else if(void 0==d.startDate&&void 0!=d.dateAndTime&&void 0==d.currentTime){startTime="",dateTime="",timer_givenDate="";var b=p.startDate.getHours()<10?"0"+p.startDate.getHours():p.startDate.getHours(),y=p.startDate.getMinutes()<10?"0"+p.startDate.getMinutes():p.startDate.getMinutes(),k=p.startDate.getSeconds()<10?"0"+p.startDate.getSeconds():p.startDate.getSeconds(),x=p.startDate.getMonth()+1<10?"0"+(p.startDate.getMonth()+1):p.startDate.getMonth()+1,C=p.startDate.getDate()<10?"0"+p.startDate.getDate():p.startDate.getDate(),D=p.startDate.getFullYear();window["startTime"+e.attr("id")]=new Date(D+"/"+x+"/"+C+" "+b+":"+y+":"+k),window["dateTime"+e.attr("id")]=new Date(p.dateAndTime);var w="withnoStart";l(e,p,w),window["timer_givenDate"+e.attr("id")]=setInterval(function(){l(e,p,w)},1e3*p.tickInterval)}else void 0!=d.currentTime?(currentTime="",timer_currentDate="",window["currentTime"+e.attr("id")]=p.currentTime,u(e,p),window["timer_currentDate"+e.attr("id")]=setInterval(function(){u(e,p)},1e3*p.tickInterval)):(countSeconds="",timer_secondsTimer="",window["countSeconds"+e.attr("id")]=p.seconds,window["timer_secondsTimer"+e.attr("id")]=setInterval(function(){c(e)},1e3));else void 0!=d.hours&&void 0==d.minutes&&void 0==d.seconds?(hours_H="",minutes_H="",seconds_H="",timer_H="",window["hours_H"+e.attr("id")]=p.hours,window["minutes_H"+e.attr("id")]=p.minutes,window["seconds_H"+e.attr("id")]=p.seconds,i(e,p),window["timer_H"+e.attr("id")]=setInterval(function(){i(e,p)},1e3*p.tickInterval)):void 0==d.hours&&void 0!=d.minutes&&void 0==d.seconds?(hours_M="",minutes_M="",seconds_M="",timer_M="",window["hours_M"+e.attr("id")]=p.hours,window["minutes_M"+e.attr("id")]=p.minutes,window["seconds_M"+e.attr("id")]=p.seconds,s(e,p),window["timer_M"+e.attr("id")]=setInterval(function(){s(e,p)},1e3*p.tickInterval)):void 0==d.hours&&void 0==d.minutes&&void 0!=d.seconds?(hours_S="",minutes_S="",seconds_S="",timer_S="",window["hours_S"+e.attr("id")]=p.hours,window["minutes_S"+e.attr("id")]=p.minutes,window["seconds_S"+e.attr("id")]=p.seconds,n(e,p),window["timer_S"+e.attr("id")]=setInterval(function(){n(e,p)},1e3*p.tickInterval)):void 0!=d.hours&&void 0!=d.minutes&&void 0==d.seconds?(hours_HM="",minutes_HM="",seconds_HM="",timer_HM="",window["hours_HM"+e.attr("id")]=p.hours,window["minutes_HM"+e.attr("id")]=p.minutes,window["seconds_HM"+e.attr("id")]=p.seconds,o(e,p),window["timer_HM"+e.attr("id")]=setInterval(function(){o(e,p)},1e3*p.tickInterval)):void 0==d.hours&&void 0!=d.minutes&&void 0!=d.seconds?(hours_MS="",minutes_MS="",seconds_MS="",timer_MS="",window["hours_MS"+e.attr("id")]=p.hours,window["minutes_MS"+e.attr("id")]=p.minutes,window["seconds_MS"+e.attr("id")]=p.seconds,a(e,p),window["timer_MS"+e.attr("id")]=setInterval(function(){a(e,p)},1e3*p.tickInterval)):void 0!=d.hours&&void 0==d.minutes&&void 0!=d.seconds?(hours_HS="",minutes_HS="",seconds_HS="",timer_HS="",window["hours_HS"+e.attr("id")]=p.hours,window["minutes_HS"+e.attr("id")]=p.minutes,window["seconds_HS"+e.attr("id")]=p.seconds,r(e,p),window["timer_HS"+e.attr("id")]=setInterval(function(){r(e,p)},1e3*p.tickInterval)):void 0!=d.hours&&void 0!=d.minutes&&void 0!=d.seconds&&(hours_HMS="",minutes_HMS="",seconds_HMS="",timer_HMS="",window["hours_HMS"+e.attr("id")]=p.hours,window["minutes_HMS"+e.attr("id")]=p.minutes,window["seconds_HMS"+e.attr("id")]=p.seconds,h(e,p),window["timer_HMS"+e.attr("id")]=setInterval(function(){h(e,p)},1e3*p.tickInterval))}function i(t,e){var i=t.attr("id");window["minutes_H"+i]==e.minutes&&window["seconds_H"+i]==e.seconds&&window["hours_H"+i]==e.hours?(window["hours_H"+i].toString().length<2&&(window["hours_H"+i]="0"+window["hours_H"+i]),p(t,window["hours_H"+i]+e.timeSeparator+"00"+e.timeSeparator+"00"),window["seconds_H"+i]=60-e.tickInterval,window["minutes_H"+i]=59,0!=window["hours_H"+i]?window["hours_H"+i]--:(delete window["hours_H"+i],delete window["minutes_H"+i],delete window["seconds_H"+i],clearInterval(window["timer_H"+i]),d(t,e))):(window["hours_H"+i].toString().length<2&&(window["hours_H"+i]="0"+window["hours_H"+i]),window["minutes_H"+i].toString().length<2&&(window["minutes_H"+i]="0"+window["minutes_H"+i]),window["seconds_H"+i].toString().length<2&&(window["seconds_H"+i]="0"+window["seconds_H"+i]),p(t,window["hours_H"+i]+e.timeSeparator+window["minutes_H"+i]+e.timeSeparator+window["seconds_H"+i]),window["seconds_H"+i]-=e.tickInterval,0!=window["minutes_H"+i]&&window["seconds_H"+i]<0&&(window["minutes_H"+i]--,window["seconds_H"+i]=60-e.tickInterval),0==window["minutes_H"+i]&&window["seconds_H"+i]<0&&0!=window["hours_H"+i]&&(window["hours_H"+i]--,window["minutes_H"+i]=59,window["seconds_H"+i]=60-e.tickInterval),0==window["minutes_H"+i]&&window["seconds_H"+i]<0&&0==window["hours_H"+i]&&(delete window["hours_H"+i],delete window["minutes_H"+i],delete window["seconds_H"+i],clearInterval(window["timer_H"+i]),d(t,e))),i=null}function s(t,e){var i=t.attr("id");window["minutes_M"+i]==e.minutes&&window["seconds_M"+i]==e.seconds?(window["minutes_M"+i].toString().length<2&&(window["minutes_M"+i]="0"+window["minutes_M"+i]),p(t,window["minutes_M"+i]+e.timeSeparator+"00"),window["seconds_M"+i]=60-e.tickInterval,0!=window["minutes_M"+i]?window["minutes_M"+i]--:(delete window["hours_M"+i],delete window["minutes_M"+i],delete window["seconds_M"+i],clearInterval(window["timer_M"+i]),d(t,e))):(window["minutes_M"+i].toString().length<2&&(window["minutes_M"+i]="0"+window["minutes_M"+i]),window["seconds_M"+i].toString().length<2&&(window["seconds_M"+i]="0"+window["seconds_M"+i]),p(t,window["minutes_M"+i]+e.timeSeparator+window["seconds_M"+i]),window["seconds_M"+i]-=e.tickInterval,0!=window["minutes_M"+i]&&window["seconds_M"+i]<0&&(window["minutes_M"+i]--,window["seconds_M"+i]=60-e.tickInterval),0==window["minutes_M"+i]&&window["seconds_M"+i]<0&&(delete window["hours_M"+i],delete window["minutes_M"+i],delete window["seconds_M"+i],clearInterval(window["timer_M"+i]),d(t,e))),i=null}function n(t,e){var i=t.attr("id");window["seconds_S"+i].toString().length<2&&(window["seconds_S"+i]="0"+window["seconds_S"+i]),p(t,window["seconds_S"+i]+" sec"),window["seconds_S"+i]-=e.tickInterval,window["seconds_S"+i]<0&&(delete window["hours_S"+i],delete window["minutes_S"+i],delete window["seconds_S"+i],clearInterval(window["timer_S"+i]),d(t,e)),i=null}function o(t,e){var i=t.attr("id");window["minutes_HM"+i]==e.minutes&&window["hours_HM"+i]==e.hours?(window["hours_HM"+i].toString().length<2&&(window["hours_HM"+i]="0"+window["hours_HM"+i]),window["minutes_HM"+i].toString().length<2&&(window["minutes_HM"+i]="0"+window["minutes_HM"+i]),p(t,window["hours_HM"+i]+e.timeSeparator+window["minutes_HM"+i]+e.timeSeparator+"00"),0!=window["hours_HM"+i]&&0==window["minutes_HM"+i]?(window["hours_HM"+i]--,window["minutes_HM"+i]=59,window["seconds_HM"+i]=60-e.tickInterval):0==window["hours_HM"+i]&&0!=window["minutes_HM"+i]?(window["seconds_HM"+i]=60-e.tickInterval,window["minutes_HM"+i]--):(window["seconds_HM"+i]=60-e.tickInterval,window["minutes_HM"+i]--),0==window["hours_HM"+i]&&0==window["minutes_HM"+i]&&60==window["seconds_HM"+i]&&(delete window["hours_HM"+i],delete window["minutes_HM"+i],delete window["seconds_HM"+i],clearInterval(window["timer_HM"+i]),d(t,e))):(window["hours_HM"+i].toString().length<2&&(window["hours_HM"+i]="0"+window["hours_HM"+i]),window["minutes_HM"+i].toString().length<2&&(window["minutes_HM"+i]="0"+window["minutes_HM"+i]),window["seconds_HM"+i].toString().length<2&&(window["seconds_HM"+i]="0"+window["seconds_HM"+i]),p(t,window["hours_HM"+i]+e.timeSeparator+window["minutes_HM"+i]+e.timeSeparator+window["seconds_HM"+i]),window["seconds_HM"+i]-=e.tickInterval,0!=window["minutes_HM"+i]&&window["seconds_HM"+i]<0&&(window["minutes_HM"+i]--,window["seconds_HM"+i]=60-e.tickInterval),0==window["minutes_HM"+i]&&window["seconds_HM"+i]<0&&0!=window["hours_HM"+i]&&(window["hours_HM"+i]--,window["minutes_HM"+i]=59,window["seconds_HM"+i]=60-e.tickInterval),0==window["minutes_HM"+i]&&window["seconds_HM"+i]<0&&0==window["hours_HM"+i]&&(delete window["hours_HM"+i],delete window["minutes_HM"+i],delete window["seconds_HM"+i],clearInterval(window["timer_HM"+i]),d(t,e))),i=null}function a(t,e){var i=t.attr("id");window["minutes_MS"+i]==e.minutes&&window["seconds_MS"+i]==e.seconds?(window["minutes_MS"+i].toString().length<2&&(window["minutes_MS"+i]="0"+window["minutes_MS"+i]),window["seconds_MS"+i].toString().length<2&&(window["seconds_MS"+i]="0"+window["seconds_MS"+i]),p(t,window["minutes_MS"+i]+e.timeSeparator+window["seconds_MS"+i]),0!=window["minutes_MS"+i]&&0==window["seconds_MS"+i]?(window["minutes_MS"+i]--,window["seconds_MS"+i]=60-e.tickInterval):0==window["minutes_MS"+i]&&0==window["seconds_MS"+i]?(delete window["hours_MS"+i],delete window["minutes_MS"+i],delete window["seconds_MS"+i],clearInterval(window["timer_MS"+i]),d(t,e)):window["seconds_MS"+i]-=e.tickInterval):(window["minutes_MS"+i].toString().length<2&&(window["minutes_MS"+i]="0"+window["minutes_MS"+i]),window["seconds_MS"+i].toString().length<2&&(window["seconds_MS"+i]="0"+window["seconds_MS"+i]),p(t,window["minutes_MS"+i]+e.timeSeparator+window["seconds_MS"+i]),window["seconds_MS"+i]-=e.tickInterval,0!=window["minutes_MS"+i]&&window["seconds_MS"+i]<0&&(window["minutes_MS"+i]--,window["seconds_MS"+i]=60-e.tickInterval),0==window["minutes_MS"+i]&&window["seconds_MS"+i]<0&&(delete window["hours_MS"+i],delete window["minutes_MS"+i],delete window["seconds_MS"+i],clearInterval(window["timer_MS"+i]),d(t,e))),i=null}function r(t,e){var i=t.attr("id");window["seconds_HS"+i]==e.seconds&&window["hours_HS"+i]==e.hours?(window["hours_HS"+i].toString().length<2&&(window["hours_HS"+i]="0"+window["hours_HS"+i]),window["seconds_HS"+i].toString().length<2&&(window["seconds_HS"+i]="0"+window["seconds_HS"+i]),p(t,window["hours_HS"+i]+e.timeSeparator+"00"+e.timeSeparator+window["seconds_HS"+i]),0==window["hours_HS"+i]&&0==window["seconds_HS"+i]?(delete window["hours_HS"+i],delete window["minutes_HS"+i],delete window["seconds_HS"+i],clearInterval(window["timer_HS"+i]),d(t,e)):0!=window["hours_HS"+i]&&0==window["seconds_HS"+i]?(window["hours_HS"+i]--,window["minutes_HS"+i]=59,window["seconds_HS"+i]=60-e.tickInterval):window["seconds_HS"+i]-=e.tickInterval):(window["hours_HS"+i].toString().length<2&&(window["hours_HS"+i]="0"+window["hours_HS"+i]),window["minutes_HS"+i].toString().length<2&&(window["minutes_HS"+i]="0"+window["minutes_HS"+i]),window["seconds_HS"+i].toString().length<2&&(window["seconds_HS"+i]="0"+window["seconds_HS"+i]),p(t,window["hours_HS"+i]+e.timeSeparator+window["minutes_HS"+i]+e.timeSeparator+window["seconds_HS"+i]),window["seconds_HS"+i]-=e.tickInterval,0!=window["minutes_HS"+i]&&window["seconds_HS"+i]<0&&(window["minutes_HS"+i]--,window["seconds_HS"+i]=60-e.tickInterval),0==window["minutes_HS"+i]&&window["seconds_HS"+i]<0&&0!=window["hours_HS"+i]&&(window["hours_HS"+i]--,window["minutes_HS"+i]=59,window["seconds_HS"+i]=60-e.tickInterval),0==window["minutes_HS"+i]&&window["seconds_HS"+i]<0&&0==window["hours_HS"+i]&&(delete window["hours_HS"+i],delete window["minutes_HS"+i],delete window["seconds_HS"+i],clearInterval(window["timer_HS"+i]),d(t,e))),i=null}function h(t,e){var i=t.attr("id");window["minutes_HMS"+i]==e.minutes&&window["seconds_HMS"+i]==e.seconds&&window["hours_HMS"+i]==e.hours?(window["hours_HMS"+i].toString().length<2&&(window["hours_HMS"+i]="0"+window["hours_HMS"+i]),window["minutes_HMS"+i].toString().length<2&&(window["minutes_HMS"+i]="0"+window["minutes_HMS"+i]),window["seconds_HMS"+i].toString().length<2&&(window["seconds_HMS"+i]="0"+window["seconds_HMS"+i]),p(t,window["hours_HMS"+i]+e.timeSeparator+window["minutes_HMS"+i]+e.timeSeparator+window["seconds_HMS"+i]),0==window["hours_HMS"+i]&&0==window["minutes_HMS"+i]&&0==window["seconds_HMS"+i]?(delete window["hours_HMS"+i],delete window["minutes_HMS"+i],delete window["seconds_HMS"+i],clearInterval(window["timer_HMS"+i]),d(t,e)):0!=window["hours_HMS"+i]&&0==window["minutes_HMS"+i]&&0==window["seconds_HMS"+i]?(window["hours_HMS"+i]--,window["minutes_HMS"+i]=59,window["seconds_HMS"+i]=60-e.tickInterval):0==window["hours_HMS"+i]&&0!=window["minutes_HMS"+i]&&0==window["seconds_HMS"+i]?(window["minutes_HMS"+i]--,window["seconds_HMS"+i]=60-e.tickInterval):0!=window["hours_HMS"+i]&&0!=window["minutes_HMS"+i]&&0==window["seconds_HMS"+i]?(window["minutes_HMS"+i]--,window["seconds_HMS"+i]=60-e.tickInterval):window["seconds_HMS"+i]-=e.tickInterval):(window["hours_HMS"+i].toString().length<2&&(window["hours_HMS"+i]="0"+window["hours_HMS"+i]),window["minutes_HMS"+i].toString().length<2&&(window["minutes_HMS"+i]="0"+window["minutes_HMS"+i]),window["seconds_HMS"+i].toString().length<2&&(window["seconds_HMS"+i]="0"+window["seconds_HMS"+i]),p(t,window["hours_HMS"+i]+e.timeSeparator+window["minutes_HMS"+i]+e.timeSeparator+window["seconds_HMS"+i]),window["seconds_HMS"+i]-=e.tickInterval,0!=window["minutes_HMS"+i]&&window["seconds_HMS"+i]<0&&(window["minutes_HMS"+i]--,window["seconds_HMS"+i]=60-e.tickInterval),0==window["minutes_HMS"+i]&&window["seconds_HMS"+i]<0&&0!=window["hours_HMS"+i]&&(window["hours_HMS"+i]--,window["minutes_HMS"+i]=59,window["seconds_HMS"+i]=60-e.tickInterval),0==window["minutes_HMS"+i]&&window["seconds_HMS"+i]<0&&0==window["hours_HMS"+i]&&(delete window["hours_HMS"+i],delete window["minutes_HMS"+i],delete window["seconds_HMS"+i],clearInterval(window["timer_HMS"+i]),d(t,e))),i=null}function l(t,e,i){var s=t.attr("id"),n="withnoStart"==i?window["dateTime"+s]:window["endDate"+s],o="withnoStart"==i?window["startTime"+s]:window["startDate"+s],a=Math.floor((n-o)/864e5),r=Math.floor((n-o)%864e5/36e5),h=Math.floor((n-o)%864e5/6e4)%60,l=Math.floor((n-o)%864e5/1e3)%60%60;n-o>0?(a.toString().length<2&&(a="0"+a),r.toString().length<2&&(r="0"+r),h.toString().length<2&&(h="0"+h),l.toString().length<2&&(l="0"+l),p(t,a+e.timeSeparator+r+e.timeSeparator+h+e.timeSeparator+l),"withnoStart"==i?window["startTime"+s].setSeconds(window["startTime"+s].getSeconds()+e.tickInterval):window["startDate"+s].setSeconds(window["startDate"+s].getSeconds()+e.tickInterval)):(p(t,"00"+e.timeSeparator+"00"+e.timeSeparator+"00"+e.timeSeparator+"00"),"withnoStart"==i?(delete window["dateTime"+s],delete window["startTime"+s],clearInterval(window["timer_givenDate"+s])):"withStart"==i&&(delete window["startDate"+s],delete window["endDate"+s],clearInterval(window["timer_startDate"+s])),d(t,e)),s=null}function u(t,e){if(1==window["currentTime"+t.attr("id")]){var i=new Date,s=i.getHours(),n=i.getMinutes(),o=i.getSeconds();s.toString().length<2&&(s="0"+s),n.toString().length<2&&(n="0"+n),o.toString().length<2&&(o="0"+o),p(t,s+e.timeSeparator+n+e.timeSeparator+o)}else alert("Set Current Time option.")}function c(t){var e=t.attr("id");window["countSeconds"+e].toString().length<2&&(window["countSeconds"+e]="0"+window["countSeconds"+e]),p(t,window["countSeconds"+e]+" sec"),window["countSeconds"+e]--,-1==window["countSeconds"+e]&&(delete window["countSeconds"+e],clearInterval(window["timer_secondsTimer"+e])),e=null}function d(e,i){null!=i.timeUp&&1==t.isFunction(i.timeUp)&&i.timeUp.apply(e,[]),null!=i.expiryUrl&&(window.location=i.expiryUrl)}function p(t,e){var i=e;if("undefined"!=typeof window["regexpMatchFormat_"+t.attr("id")]&&"undefined"!=typeof window["regexpReplaceWith_"+t.attr("id")]){var s=new RegExp(window["regexpMatchFormat_"+t.attr("id")]);i=e.replace(s,window["regexpReplaceWith_"+t.attr("id")])}t.html(i)}t.fn.countdowntimer=function(i){return this.each(function(){e(t(this),i)})},t.fn.countdowntimer.defaults={hours:0,minutes:0,seconds:60,startDate:new Date,dateAndTime:new Date("0000/00/00 00:00:00"),currentTime:!1,size:"sm",borderColor:"#F0068E",fontColor:"#FFFFFF",backgroundColor:"#000000",timeSeparator:":",tickInterval:1,timeUp:null,expiryUrl:null,regexpMatchFormat:null,regexpReplaceWith:null}}(jQuery);